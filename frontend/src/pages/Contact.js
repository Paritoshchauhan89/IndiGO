...
import Boy from '../components/Assets/boy-Avator.png'; // Adjust the path as needed
        ...
        <main className="flex-grow container mx-auto p-4 flex flex-col md:flex-row">
          <div className="w-full md:w-1/2 flex justify-center items-center p-4">
            <img
              src={Boy}
              alt="Portrait"
              className="rounded-full h-32 md:h-48 lg:w-64 lg:h-64"
            />
          </div>
          <div className="w-full md:w-1/2 flex flex-col justify-center items-start p-4">
            ...
            >
              <img src={whatsappGif} alt="WhatsApp" className="mr-2 w-8 h-8 md:w-10 md:h-10" />
              WhatsApp
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <img src={Call} alt="Call" className="mr-2 w-8 h-8 md:w-10 md:h-10" />
              Call Now
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 48 48">
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <img src={Netlify} alt="Portfolio" className="mr-2 w-8 h-8 md:w-10 md:h-10" />
              Portfolio
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <img src={Github} alt="GitHub" className="mr-2 w-8 h-8 md:w-10 md:h-10" />
              GitHub
            </a>
          </div>
        </main>
